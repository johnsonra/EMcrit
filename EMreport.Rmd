...
The table above gives analysis results of historical environmental montioring data and contains the following columns:
...
† The zero-inflated negative binomial model accounts for overdispersion of observations that results in applications where there are an excess of zeros.